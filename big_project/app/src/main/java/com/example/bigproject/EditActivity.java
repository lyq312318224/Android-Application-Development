...
public class EditActivity extends AppCompatActivity implements View.OnClickListener, MyAdapterpic.IOnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        posbefore=-1;
        initProgressDialog();
//        mVideoView = findViewById(R.id.editvideo);
...
//        mVideoView.setMediaController(mc);
        ...
        textView.setText("视频大小："+videodata.length/1000000+"MB");
        if(videodata.length/1000000>30){
            Button button = findViewById(R.id.test_btn_play);
            button.setVisibility(View.INVISIBLE);
            textView.setText("视频大小："+videodata.length/1000000+"MB, 过大！请重新选择！");
        }
...
//                }
    ...
    public void onItemCLick(int position, picdata data) {
        coverImageUri = Uri.parse(MediaStore.Images.Media.insertImage(getContentResolver(), data.bitmap, null,null));
