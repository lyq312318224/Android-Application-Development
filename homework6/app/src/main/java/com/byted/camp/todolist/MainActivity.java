...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notesAdapter = new NoteListAdapter(new NoteOperator() {
            ...
            public void deleteNote(Note note) {
                ...
                int deleteRows=database.delete(TodoNote.TABLIE_NAME,TodoNote._ID+"=?",new String[]{String.valueOf(note.id)});
                if (deleteRows>0){
            ...
            public void updateNote(Note note) {
                ...
                int count=database.update(TodoNote.TABLIE_NAME,values,TodoNote._ID+"=?",
    ...
    private List<Note> loadNotesFromDatabase() {
        ...
        Cursor cursor=null;
        try{
            cursor=database.query(TodoNote.TABLIE_NAME,
                    null,null,null,null,null,
                    TodoNote.COLUMN_PRIORIYT+" DESC");
            while (cursor.moveToNext()){
                ...
                int intPriority = cursor.getInt(cursor.getColumnIndex(TodoNote.COLUMN_PRIORIYT));
